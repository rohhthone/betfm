...
<html lang="ru-RU">
    <head>
        ...
        <title>BET FM &#8212; Прогнозы на ставки</title>
<meta name='robots' content='max-image-preview:large' />
<link rel='stylesheet' id='classic-theme-styles-css' href='http://betfm.ru/wp-includes/css/classic-themes.min.css?ver=1' type='text/css' media='all' />
...
<link rel='stylesheet' id='styles-css' href='http://betfm.ru/wp-content/themes/barebones-master/style.css?1666011448&#038;ver=6.1.1' type='text/css' media='all' />
<link rel="https://api.w.org/" href="http://betfm.ru/index.php?rest_route=/" /><link rel="alternate" type="application/json" href="http://betfm.ru/index.php?rest_route=/wp/v2/pages/28" /><link rel="canonical" href="http://betfm.ru/" />
<link rel="alternate" type="application/json+oembed" href="http://betfm.ru/index.php?rest_route=%2Foembed%2F1.0%2Fembed&#038;url=http%3A%2F%2Fbetfm.ru%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://betfm.ru/index.php?rest_route=%2Foembed%2F1.0%2Fembed&#038;url=http%3A%2F%2Fbetfm.ru%2F&#038;format=xml" />
        <!-- Global site tag (gtag.js) - Google Analytics -->
...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://rohhthone.com/API/ro.css">
  <meta charset="UTF-8">
...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>BETFM</title>
  <meta name="description" content="Новостная редакция бесплатных ставок на спорт.">
...
<body class="advertising">
  ...
  <main>
    <style>
      main{width: var(--width_h); height: auto; background-color: var(--black);}
    </style>
    <div class="landing">
      <style>
        .landing{display: flex; align-items: center; justify-content: space-between; width: 100%; height: calc(var(--width_h) * 0.25);}
        .landing>div{height: inherit;}
        .main{width: 100%; min-width: 60%;}
        .main>.img{width: 100%; height: 100%; display: flex;}
        .main>.img>.action{display: grid; grid-template-columns: repeat(2,1fr); width: inherit; background-color: #111c;height: inherit; display: flex;align-items: flex-end; justify-content: center;}
        .action>a{height: var(--h2); display: flex; align-items: center; justify-content: space-around;width: auto; margin: var(--s1); border-radius: var(--s1); letter-spacing: var(--upperspacing); font-weight: 600; padding: 0 var(--s0);}
        .action>a.first{ background-color: var(--brand-c); color: var(--black);}
        .action>a.second{ background-color: var(--brand-c1); color: var(--white);}

      </style>
      <div class="main">
        <div class="img" style="background-image: url(https://rohhthone.github.io/betfm/images/1.png);">
          <div class="action">
            <a href="#football" class="first brand">МАТЧИ СЕГОДНЯ</a>
            <a href="#express" class="second">ЭКСПРЕССЫ СЕГОДНЯ</a>
          </div>
        </div>
      </div>
      <div class="side">
    ...
    <h2 class="phone" style="font-size: 1.4em; margin: 16px 0; text-align: center; align-items: center; justify-content: space-around;">Ближайшие прогнозы</h2>
    <div class="content">
      <style>
      .content{width: 100%;height: auto; display: flex; justify-content: space-between; flex-wrap: wrap;}
      .content>.main{width: calc(var(--width_h) - 350px);}
      .content>.main>.sport{width: 100%; height: auto; background-color: var(--black);display: flex; flex-direction: column;}
      .content>.main>.sport>.header>button{display: none;}
      .sport>.content{display: flex; flex-direction: column;}
      .sport>.header{width: 100%; height: var(--h); display: flex; align-items: center; background-color: var(--brand-c); box-sizing: border-box; padding: 0 var(--s2); color: var(--black);}
      .sport>.header>*{margin: var(--s1);}
      .sport>.header>h2{font-size: var(--f0); font-weight: 600; display: flex; align-items: center;}
      .sport button{background-color: var(--black); width: var(--h1); height: var(--h2); border: none; border-radius: var(--s2);}
      button>span.up::before{content:"\276F";transform: rotate(-90deg); color: var(--white); display: block;}
      button>span.down::before{content:"\276F";transform: rotate(90deg); color: var(--white); display: block;}

      .bet{display: flex; flex-direction: column; align-items: center; box-sizing: border-box;}
      .bet>.header{width: 100%; display: flex;  justify-content: space-between;height: var(--h2); align-items: center; border-top: calc(var(--s4)) solid #fff5; padding: var(--s1) 0; font-size: var(--f2);}
      ...
      .bet>.body>.prognose>.line{width: 100%; height: var(--h1); background-color: var(--brand-c); display: flex; color: var(--black); display: flex; align-items: center; justify-content: space-between;}
      .bet>.body>.prognose>.line>h3{padding: 0 var(--h2); font-style: italic; font-size: large; font-weight: 600;}
      .bet>.body>.prognose>.line>a{font-size: var(--f1); font-weight: 600; height: 100%; padding: 0 0; display: flex; align-items: center; justify-content: space-around;}
      .bet>.body>.prognose>.line>a>svg{width: 100%; height: 100%;}
      .bet>.body>.prognose>.line>a>svg>text{font-size: calc(var(--f0) * 2.2 ); fill: var(--white);}
      .bet>.body>.prognose>.line>a>svg>polyline{fill: #222;}
      .bet>.body>.action{width: 100%; height: var(--h2); display: flex; align-items: center; justify-content: space-around; margin: var(--s2) 0 0 0;}
      .bet:not(.active)>.body{display: none;}
  ...
  <div class="header">
    ...
    <div class="image icon onlyphone">
        ...
        @media screen and (max-width:100vh) {
            ...
            .active>.image.icon.onlyphone>img{width: 32px; height: auto;}
        }
        </style>
        <img src="<?= $row["team1_logo"] ?>" alt="Logo" class="logo">
        <img src="<?= $row["team2_logo"] ?>" alt="Logo" class="logo">
    </div>
      <div class="body">
        <p><?= $row["description"] ?></p>
        <div class="prognose">
...
if ($result->num_rows > 0) {
  ...
  ?>
        <div class="sport" id="hockey">
          <div class="header">
            <h2><svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="300 300 600 600"><defs><style>.cls-1{fill:#111;}</style></defs><path class="cls-1" d="M517.61,448.68c57.56.78,108.14,5.95,156.84,23.13,18.32,6.46,35.87,14.6,50.91,27.27,8.18,6.89,15,14.84,18.19,25.3,5,16.58-3.94,28-14.94,38.31-16.57,15.52-36.94,24.45-57.88,32.2-39.17,14.51-79.83,21.8-121.4,23.81-56.6,2.75-112.25-2.79-166.13-21.4-23.09-8-45.57-17.26-64-34a75.4,75.4,0,0,1-8.69-9.18c-12-15.23-10.71-32.14,3.13-47.2,15.39-16.75,35.21-26.24,56-34,33.82-12.66,69.08-18.85,104.92-21.84C490.92,449.74,507.42,449.23,517.61,448.68Zm19.7,142.89.17,1.23c23.36-2.86,46.85-5,70.07-8.78,24.63-4,48.64-10.85,70.29-23.9,13.09-7.9,24.3-17.59,26.27-34.19.7-5.87-2-10-7-10.58-5.19-.65-9.07,2.27-9.71,8.18a20.84,20.84,0,0,1-8.53,15c-6.44,4.72-13.13,9.41-20.34,12.75-30,13.87-62.12,19-94.7,21.65-13.17,1.09-26.42,1.08-39.63,1.75-6,.31-9.24,3.76-8.94,9,.28,4.94,3.56,7.73,9.42,7.85C528.87,591.64,533.09,591.57,537.31,591.57Z"/><path class="cls-1" d="M744.72,561.24c0,24,.52,46.42-.19,68.82-.42,12.9-9.44,21.47-19,28.79-19.41,14.79-42,22.89-65.2,29.14-55.37,14.88-111.89,18.36-168.9,15.65-39.39-1.87-78.28-7.19-116-19-18.89-5.91-37.16-13.3-53.21-25.3-13.19-9.87-21.16-22-20.33-39.47.82-17.22.17-34.52.19-51.78,0-1.83.15-3.66.26-6,33,36.06,76.79,48.16,121.65,56.58a540.24,540.24,0,0,0,209.87-2c26.57-5.44,52.3-13.6,76.21-26.72C723,582.83,734.7,574.07,744.72,561.24Z"/></svg>Хоккей</h2>
            <button><span class="up"></span></button>
            <button><span class="down"></span></button>
          </div>
          <div class="content">
...
?>
    ...
    <div class="footer">
      ...
      <div class="description">
        ...
        <a href="#fighting">Бокс и ММА</a>
        <a href="#express">Экспресс</a>
...
Все материалы для лиц старше 18 лет.<br>
Редакция не несет ответственноси за достоверность прогнозов, все прогнозы являются предположением на основе открытой аналитики спорта.<br>
При использовании материалов с сайта просим использовать ссылку на Betfm<br><br>

Свидетельство о регистрации СМИ Эл. № ФСXX-XXXXX<br><br>

Для связи с редакцией: info@betfm.ru
    </div>
  </main>
  <footer>
    ...
    <a href="https://rohhthone.com/">rohh</a>
    <a href="https://rohhthone.com/privacy">privacy</a>
  </footer>
  <script>
    ...
    function ok(){
        document.getElementsByClassName('sport')[0].classList.toggle('hidden');
        console.log('work');
  ...
  <style>
    .sport.hidden::before{display: none !important;}
  </style>
  <style>
    .content>.main>.sport{position: relative; margin: 32px 0 0 0;}
    
    .content>.main>.sport:before{
        content:"";
        height:4px; background-color: #fff7; width: 100%; position: relative; top: -16px; left: 0;display: block;
    }
    .sport:first-of-type{
        display: none;
    }
